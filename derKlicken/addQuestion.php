...
<form name="myForm" method="post" onsubmit="return validateForm()" action="addQuestion.php">
<?php include('errors.php'); ?> 
 <div class="container">
    <h1>Add Question</h1>
    <p>Please fill in this form to add a new question.</p>
    <hr>
    ...
    <button type="submit" name="newQuestion" class="registerbtn">Add</button>
  </div>
</body>
</html>
