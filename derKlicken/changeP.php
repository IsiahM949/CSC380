...
<form name="myForm" method="post" onsubmit="return validateForm()" action="changeP.php">
<?php include('errors.php'); ?> 
 <div class="container">
    <h1>Change Password</h1>
    <p>Enter Username and Email of Account to change password</p>
    <hr>
    ...
    <button type="submit" name="changeP" class="registerbtn">Change</button>
  </div>
</body>
</html>
